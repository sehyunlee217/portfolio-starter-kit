...
Feeling uncertain, I intentionally made the decision to choose the safest and most flexible option
for my undergrad. However, I now realize—_being curious and open to learn and understand is one of my greatest strengths_.
...
I have experience working with Python, JavaScript, and Java; frameworks such as React, Node JS, tailwind, d3, and NEXT.JS.

I'm completing [mlcourse.ai](https://mlcourse.ai/book/index.html) by the end of the semester, and
is in process of learning Scala, ApacheSpark, SQL, alongside other interesting programming languages or topics that show up along the way.

I also share a passion for the arts and various hobbies. Some of my most recent hobbies are: making coffee, collecting records, and cooking.

---

- **Industrial Engineering Student** at University of Toronto
- Born in **Korea**, currently located in **Toronto**.
